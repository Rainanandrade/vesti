...
const styles = StyleSheet.create({
  ...
  topicBar: { maxHeight: 60, borderBottomWidth: 1, borderColor: colors.divider },
  topicChip: { paddingHorizontal: spacing.md, paddingVertical: 8, borderRadius: radius.pill, backgroundColor: colors.background, borderWidth: 1, borderColor: colors.border, marginRight: spacing.sm },
  topicChipActive: { backgroundColor: colors.primary, borderColor: colors.primary },
  topicText: { fontSize: fontSize.small, color: colors.textSecondary, fontWeight: '600' },
  topicTextActive: { color: colors.textLight, fontWeight: '700' },
